...
| Rules | [`rules/technologies.yaml`](rules/technologies.yaml) (≈120 signatures), [`capybari-core/lifecycle/eol.yaml`](https://github.com/capybari-repo/capybari-core/blob/main/lifecycle/eol.yaml) (shared) |
